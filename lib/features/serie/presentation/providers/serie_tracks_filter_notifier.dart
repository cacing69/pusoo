...
part 'serie_tracks_filter_notifier.g.dart';

@Riverpod(keepAlive: true)
class SerieTracksFilterNotifier extends _$SerieTracksFilterNotifier {
  @override
  TrackFilterQuery build() {
    return TrackFilterQuery(isTvSerie: true, limit: 20);
  }
  ...
  void reset() {
    state = TrackFilterQuery(isTvSerie: true, limit: 20);
  }
}
