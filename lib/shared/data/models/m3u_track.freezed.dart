...
mixin _$M3UTrack {
 ...
 String get title; List<String> get links; String get duration; Map<String, String> get attributes; List<Map<String, String>> get extVlcOpt; List<Map<String, String>> get kodiProp; List<Map<String, String>> get httpHeaders;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is M3UTrack&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.links, links)&&(identical(other.duration, duration) || other.duration == duration)&&const DeepCollectionEquality().equals(other.attributes, attributes)&&const DeepCollectionEquality().equals(other.extVlcOpt, extVlcOpt)&&const DeepCollectionEquality().equals(other.kodiProp, kodiProp)&&const DeepCollectionEquality().equals(other.httpHeaders, httpHeaders));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,const DeepCollectionEquality().hash(links),duration,const DeepCollectionEquality().hash(attributes),const DeepCollectionEquality().hash(extVlcOpt),const DeepCollectionEquality().hash(kodiProp),const DeepCollectionEquality().hash(httpHeaders));

@override
String toString() {
  return 'M3UTrack(title: $title, links: $links, duration: $duration, attributes: $attributes, extVlcOpt: $extVlcOpt, kodiProp: $kodiProp, httpHeaders: $httpHeaders)';
}
...
@useResult
$Res call({
 String title, List<String> links, String duration, Map<String, String> attributes, List<Map<String, String>> extVlcOpt, List<Map<String, String>> kodiProp, List<Map<String, String>> httpHeaders
});
...
/// Create a copy of M3UTrack
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? links = null,Object? duration = null,Object? attributes = null,Object? extVlcOpt = null,Object? kodiProp = null,Object? httpHeaders = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  List<String> links,  String duration,  Map<String, String> attributes,  List<Map<String, String>> extVlcOpt,  List<Map<String, String>> kodiProp,  List<Map<String, String>> httpHeaders)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _M3UTrack() when $default != null:
return $default(_that.title,_that.links,_that.duration,_that.attributes,_that.extVlcOpt,_that.kodiProp,_that.httpHeaders);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  List<String> links,  String duration,  Map<String, String> attributes,  List<Map<String, String>> extVlcOpt,  List<Map<String, String>> kodiProp,  List<Map<String, String>> httpHeaders)  $default,) {final _that = this;
switch (_that) {
case _M3UTrack():
return $default(_that.title,_that.links,_that.duration,_that.attributes,_that.extVlcOpt,_that.kodiProp,_that.httpHeaders);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  List<String> links,  String duration,  Map<String, String> attributes,  List<Map<String, String>> extVlcOpt,  List<Map<String, String>> kodiProp,  List<Map<String, String>> httpHeaders)?  $default,) {final _that = this;
switch (_that) {
case _M3UTrack() when $default != null:
return $default(_that.title,_that.links,_that.duration,_that.attributes,_that.extVlcOpt,_that.kodiProp,_that.httpHeaders);case _:
  return null;
...
class _M3UTrack implements M3UTrack {
  const _M3UTrack({this.title = "", final  List<String> links = const [], this.duration = "", final  Map<String, String> attributes = const {}, final  List<Map<String, String>> extVlcOpt = const [], final  List<Map<String, String>> kodiProp = const [], final  List<Map<String, String>> httpHeaders = const []}): _links = links,_attributes = attributes,_extVlcOpt = extVlcOpt,_kodiProp = kodiProp,_httpHeaders = httpHeaders;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _M3UTrack&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other._links, _links)&&(identical(other.duration, duration) || other.duration == duration)&&const DeepCollectionEquality().equals(other._attributes, _attributes)&&const DeepCollectionEquality().equals(other._extVlcOpt, _extVlcOpt)&&const DeepCollectionEquality().equals(other._kodiProp, _kodiProp)&&const DeepCollectionEquality().equals(other._httpHeaders, _httpHeaders));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,const DeepCollectionEquality().hash(_links),duration,const DeepCollectionEquality().hash(_attributes),const DeepCollectionEquality().hash(_extVlcOpt),const DeepCollectionEquality().hash(_kodiProp),const DeepCollectionEquality().hash(_httpHeaders));
...
/// Create a copy of M3UTrack
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? links = null,Object? duration = null,Object? attributes = null,Object? extVlcOpt = null,Object? kodiProp = null,Object? httpHeaders = null,}) {
