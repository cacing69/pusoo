...
_SubtitleAttribute _$SubtitleAttributeFromJson(
  ...
  uploader: json['uploader'] == null
      ? null
      : AttributeUploader.fromJson(json['uploader'] as Map<String, dynamic>),
  featureDetails: (json['feature_details'] as List<dynamic>?)
      ?.map((e) => AttributeFeatureDetail.fromJson(e as Map<String, dynamic>))
      .toList(),
