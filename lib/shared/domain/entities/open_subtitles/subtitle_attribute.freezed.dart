...
as AttributeFeatureDetail?,url: freezed == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$AttributeFeatureDetailCopyWith<$Res>? get featureDetails {
    if (_self.featureDetails == null) {
    return null;
  }

  return $AttributeFeatureDetailCopyWith<$Res>(_self.featureDetails!, (value) {
    return _then(_self.copyWith(featureDetails: value));
  });
}
}
...
@override@JsonKey(name: "feature_details") final  AttributeFeatureDetail? featureDetails;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,subtitleId,language,downloadCount,newDownloadCount,hearingImpaired,hd,fps,votes,ratings,fromTrusted,foreignPartsOnly,uploadDate,aiTranslated,nbCd,slug,machineTranslated,release,comments,legacySubtitleId,legacyUploaderId,uploader,featureDetails,url,const DeepCollectionEquality().hash(_relatedLinks),const DeepCollectionEquality().hash(_files)]);
...
@override $AttributeUploaderCopyWith<$Res>? get uploader;@override $AttributeFeatureDetailCopyWith<$Res>? get featureDetails;
