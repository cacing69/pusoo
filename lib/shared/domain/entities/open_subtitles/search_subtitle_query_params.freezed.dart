...
@override@JsonKey(name: "foreign_parts_only") final  String? foreignPartsOnly;
@override@JsonKey(name: "hearing_impaired") final  String? hearingImpaired;
@override@JsonKey(name: "id") final  int? id;
@override@JsonKey(name: "imdb_id") final  int? imdbId;
@override final  String? languages;
@override@JsonKey(name: "machine_translated") final  String? machineTranslated;
@override final  String? moviehash;
...
@override@JsonKey(name: "trusted_sources") final  String? trustedSources;
